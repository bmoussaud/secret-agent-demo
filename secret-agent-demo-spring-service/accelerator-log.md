...
```json
{
  "artifactId" : "secret-agent",
  "buildTool" : "maven",
  "databaseIntegrationTestType" : "in-memory",
  "databaseMigrationTool" : "flyway",
  "databaseName" : "kcd-fr-23-database",
  "databasePostgresMonitoringClass" : "standard",
  "databasePostgresStorageClass" : "standard",
  "databaseType" : "postgres",
  "exposeOpenAPIEndpoint" : false,
  "groupId" : "org.moussaud.sb",
  "javaVersion" : "17",
  "liveUpdateIDESupport" : true,
  "packageName" : "org.moussaud.sb.secretagent",
  "projectName" : "secret-agent-demo-spring-service",
  "sourceRepositoryPrefix" : "akseutap4registry.azurecr.io"
}
```
## Log
```
...
┃ ┃ ┃ Debug Adding symbol packageDirectory with value 'org/moussaud/sb/secretagent'
┃ ┃ ┃ Debug Adding symbol workloadResourceName with value 'secret-agent'
...
┃ ┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [<groupId>com.vmware.tap.accelerators</groupId>-><groupId>org.moussau...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [rest-service-db->secret-agent]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol databaseResourceName with value 'kcd-fr-23-database'
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [postgres-database->kcd-fr-23-database]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [storage-class-standard->standard, postgresdatabase->kcd-fr-23-database, postgres-database->kcd-fr-23-database, monitoring-storage-class-standard->standard]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [my-project->secret-agent]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [dev.local->akseutap4registry.az...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [com.vmware.tap.accelerators.restservicedb->org.moussaud.sb.secr...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/moussaud/sb/secretagent/data/CustomerProfileEntity.java didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug mvnw didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/postgres-cluster-role.yaml didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/moussaud/sb/secretagent/data/CustomerProfileRepository.java didn't match [**/*.jar] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/moussaud/sb/secretagent/domain/CustomerProfileResponse.java didn't match [**/*.jar] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/org/moussaud/sb/secretagent/ApplicationTests.java didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug .tanzuignore didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug LICENSE didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/moussaud/sb/secretagent/domain/CustomerProfileService.java didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/moussaud/sb/secretagent/api/CustomerProfileController.java didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug mvnw.cmd didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/moussaud/sb/secretagent/domain/CustomerProfileCreateRequest.java didn't match [**/*.jar] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/org/moussaud/sb/secretagent/data/CustomerProfileRepositoryTest.java didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/resources/application-local.properties didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/moussaud/sb/secretagent/domain/CustomerProfileChangeRequest.java didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/org/moussaud/sb/secretagent/domain/CustomerProfileServiceTest.java didn't match [**/*.jar] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/org/moussaud/sb/secretagent/api/CustomerProfileControllerTest.java didn't match [**/*.jar] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/moussaud/sb/secretagent/Application.java didn't match [**/*.jar] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/moussaud/sb/secretagent/data/CustomerProfileEntity.java didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug mvnw didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/postgres-cluster-role.yaml didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/moussaud/sb/secretagent/data/CustomerProfileRepository.java didn't match [**/*.jar] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/moussaud/sb/secretagent/domain/CustomerProfileResponse.java didn't match [**/*.jar] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/org/moussaud/sb/secretagent/ApplicationTests.java didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug .tanzuignore didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug LICENSE didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/moussaud/sb/secretagent/domain/CustomerProfileService.java didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/moussaud/sb/secretagent/api/CustomerProfileController.java didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug mvnw.cmd didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/moussaud/sb/secretagent/domain/CustomerProfileCreateRequest.java didn't match [**/*.jar] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/org/moussaud/sb/secretagent/data/CustomerProfileRepositoryTest.java didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/resources/application-local.properties didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/moussaud/sb/secretagent/domain/CustomerProfileChangeRequest.java didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/org/moussaud/sb/secretagent/domain/CustomerProfileServiceTest.java didn't match [**/*.jar] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/org/moussaud/sb/secretagent/api/CustomerProfileControllerTest.java didn't match [**/*.jar] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/moussaud/sb/secretagent/Application.java didn't match [**/*.jar] -> included
